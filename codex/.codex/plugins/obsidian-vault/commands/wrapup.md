...
For each confirmed item, use the `obsidian-note-taker` skill and the `obsidian` MCP tools. Follow the vault rules from `../agents/note-taker.md`; do not duplicate large note-routing explanations in the user-facing response.
